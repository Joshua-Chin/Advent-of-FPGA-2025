...
module M = Advent_of_fpga_2025.Day10_2.Test
...
let test_case = Day10_2.Parser.TestCase.Of_bits.of_int 0 in
  ...
  buttons.(5) := of_button 0b1000;
  buttons.(4) := of_button 0b1010;
  buttons.(3) := of_button 0b0100;
  buttons.(2) := of_button 0b1100;
  buttons.(1) := of_button 0b0101;
  buttons.(0) := of_button 0b0011;
